  ...
  return (
    <section id="contacto" className="bg-black py-20 border-t border-gold/20">
      <div className="max-w-6xl mx-auto px-6">
        ...
        {/* TÍTULO */}
        <h2 className="text-3xl md:text-4xl font-semibold text-gold text-center tracking-widest font-[Cinzel]">
          Contacto
        </h2>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
          ...
          {/* LOGO GRANDE */}
          <div className="border border-gold/30 rounded-md p-6 flex items-center justify-center bg-[#0a0a0a]">
            <Image
              src="/logo.png"
              alt="Logo Banda"
              width={220}
          ...
          {/* INFO + FORM */}
          <div className="border border-gold/30 rounded-md p-6 bg-[#0a0a0a] flex flex-col justify-between">
            
            {/* INFO */}
            <div className="space-y-4 text-amber-200">
              <div>
                <h3 className="text-gold font-semibold">Dirección</h3>
                <p>Bonares, Huelva (España)</p>
              </div>

              <div>
                <h3 className="text-gold font-semibold">Email</h3>
                <p>contacto@bandabonares.com</p>
              </div>

              <div>
                <h3 className="text-gold font-semibold">Teléfono</h3>
                <p>+34 600 000 000</p>
              </div>

              <div>
                <h3 className="text-gold font-semibold">Redes sociales</h3>
            ...
            <form className="mt-6 space-y-3">
              <input
                type="text"
                placeholder="Nombre"
                className="w-full p-3 bg-black border border-gold/30 rounded-md text-amber-200"
              />
              <input
                type="email"
                placeholder="Email"
          ...
          {/* MAPA */}
          <div className="border border-gold/30 rounded-md overflow-hidden bg-[#0a0a0a]">
            <iframe
